...
<body>
    ...
    <div class="student-info">
        ...
        <p><strong>ФИО:</strong> {{ isset($student->name) && !empty($student->name) ? $student->name : 'Не указано' }}</p>
    ...
    <div style="width: 100%; margin-bottom: 20px;">
        ...
        <div style="width: 20%; float: left; padding: 10px; text-align: center; border: 1px solid #ddd;">
